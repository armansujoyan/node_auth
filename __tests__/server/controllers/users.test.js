...
/* eslint no-undef: 0, no-unused-expressions: 0, no-underscore-dangle: 0, no-unused-vars: 0 */
...
const userController = rewire('../../../server/controllers/usersController.js');
...
describe('Users controller', () => {
  ...
  const res = {
    json: function() { return this } , // eslint-disable-line
    status: function() { this.send = function() {return this}; return this;} // eslint-disable-line
  };
  ...
  describe('signIn', () => {
    ...
    it('should return fake token using rewire', async () => {
      ...
      const signToken = userController.__set__('signToken', user => 'fakeToken');
  ...
  describe('signUp', () => {
    ...
    it('should return fake token in res.json', async () => {
      ...
      const signToken = userController.__set__('signToken', user => 'fakeTokenNumberTwo');
  ...
  describe('googleOAuth', () => {
    it('should return token if user passed the passport google oauth', async () => {
      ...
      const signToken = userController.__set__('signToken', user => 'fakeTokenFromGoogleController');
  ...
  describe('facebookOAuth', () => {
    it('should return token if user passed the passport facebook oauth', async () => {
      ...
      const signToken = userController.__set__('signToken', user => 'fakeTokenFromFacebookController');
